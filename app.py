...
def page_presentation():
    ...
    st.markdown("""
    ## Présentation
    Ce projet a été développé avec **Python** et **Streamlit** dans le but de visualiser, analyser et explorer les données financières d'une entreprise sous plusieurs angles : par compte, par année, par trimestre, etc.

    ### Fonctions principales
    - Visualisation des données originales et filtrées
    - Analyse de l'évolution annuelle des comptes
    - Suivi des marges bénéficiaires (trimestriellement et annuellement)
